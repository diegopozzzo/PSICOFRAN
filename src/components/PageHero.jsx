...
export default function PageHero({ eyebrow, title, lead, tone = 'blush', children }) {
  return (
    <section className="relative overflow-hidden px-4 pb-16 pt-32 sm:pb-20 sm:pt-40">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <Reveal delay={80}>
          <h1 className="mt-6 font-serif text-4xl leading-[1.08] tracking-tight text-espresso-900 sm:text-6xl">
            {title}
          </h1>
        </Reveal>
        {lead && (
